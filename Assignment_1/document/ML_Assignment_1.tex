...
Figure \ref{fig:census_knn_1} shows the Census KNN classifier.  Manhattan Distance worked the best, with larger values of K for more neighbors working better.
